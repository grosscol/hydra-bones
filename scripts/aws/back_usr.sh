...
wget https://s3.amazonaws.com/grosscol-hydra-scripts/setup-deb-fedora -O /home/admin/fedora-setup.sh
wget https://s3.amazonaws.com/grosscol-hydra-scripts/setup-deb-solr -O /home/admin/solr-setup.sh
